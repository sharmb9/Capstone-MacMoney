...
import sad from '../assets/sad.png';
  ...
  const questions = [{
    ...
    answerOptions: [
        { answerText: "On Campus", img: oncampus, feedback: "Nice! you decided to live on campus with fellow first years. Everything is already paid up front. " },
        { answerText: "Off Campus", img: offcampus, feedback: "Great choice! I did the same thing during my first year. You get to save quite more compared to living on campus and get to enjoy your freedom." },
        { answerText: "Commute", img: commute, feedback: "Domestic bliss!. The cheapest of the three options. You will be saving a lot of money by commuting and will not have to worry too much about spending money on food and accomodation." },
    ],
...
},
{
    ...
    answerOptions: [
        { answerText: "Campus store", img: store, feedback: "Buying from campus store is a good idea especially if you need the latest edition but are usually expensive." },
        { answerText: "Libraries", img: library, feedback: "Renting from libraries is always a good way to avoid paying for textbooks but remeber libraries might not have all the textbooks you require." },
        { answerText: "Buy second-hand", img: second, feedback: "Buying second-hand from someone else is most convinient way to save money on textbooks, you can also sell these to someone else once you are done with the course."}
    ],
...
},
{
    ...
    answerOptions: [
        ...
        { answerText: "Cash", img: cash, feedback: 'Having cash on hand is good but having a credit card is better. Often credit cards provide alot of benifits such as cashback or even airmiles that you can use to book flight tickets' },
        { answerText: "Credit Card", img: visa, feedback: 'Perfect! Making payements using credit cards ensures that you are building up a good credit score which can help you get loan from bank or renting out apartments in future. Credit cards also provide cashbacks and other benifits that you can use to buy other things ' },
        { answerText: "Debit Card", img: debit, feedback: 'Using a debit card is convinient having a credit card along with debit card can provide you alot more benifits such as cashbacks, airmiles and a good credit score.' }
    ],
...
},
{
    ...
    answerOptions: [
        ...
        { answerText: "Save", img: save, feedback: "Saving your leftover money a good way to create an emergency fund, specially if you are out of your job or need  urgent money for some other reasons. But once you have created an emergency fund usign your saving it is good idea to start thinking about investing to compound you money." },
...
},
{
    ...
    answerOptions: [
        { answerText: "I file my own taxes", img: filetax, feedback: "Great! Just make sure you know what you are doing and if you ever need help, McMaster has MacMoney center that runs clinics to help you do your taxes. Just make sure you have you SIN number and tax documents with you when you visit them." },
        { answerText: "Hire a professional", img: professional, feedback: "Make sure you choose a trusted professional." },
        { answerText: "No, I have never", img: sad, feedback: "Filling taxes can be intimidating, especially if you have never done them before. Filling taxes does not just mean paying money to government, infact you also get something called tax return which is basically some cash in hand that you can always save or invest." }
    ],
...
},
{
    ...
    answerOptions: [
        { answerText: "Yes", img: yes, feedback: "Great! Just make sure you are using trusted resources aproved by the government." },
        { answerText: "No", img: no, feedback: "There are alot of free resources such as tax clinics and websites such as SimpleTax and TurboTax that let you file your taxes for free. " }
    ],
...
},
{
    ...
    answerOptions: [
        { answerText: "Yes", img: yes, feedback: "That is perfect! Seems like you are on a right track to file your taxes. Again make sure to reach out to MacMoney center if you do need any assistance." },
        { answerText: "No", img: no, feedback: "As a university student you usually require you Tution forms that you can access through Mosaic, your rent receipts and your T4 forms if you are wokring while studying which you can get from your employer. Other than that make sure you have you SIN number with you when filling taxes." }
    ],
