  ...
  function closeFeedbackHandler() {
    ...
    return (
      <div className='npc-text '>
        ...
        <button className='btn btn-round' onClick={showFeedbackHandler}>
          Next
        </button>
        {/* </div> */}
        </div>
        ...
        {showFeedback && <Feedback text='Back when I started uni I was solely using debit and cash for all my purchases. 
                  If I knew about credit card and it’s benifits, I could have earned a lot of cashback and maybe even a free plane ticket  D: If I knew about credit card and it’s benifits, I could have earned a lot of cashback and maybe even a free plane ticket  D:
                  If I knew about credit card and it’s benifits, I could have earned a lot of cashback and maybe even a free plane ticket  D:
                  If I knew about credit card and it’s benifits, I could have earned a lot of cashback and maybe even a free plane ticket  D:' onClose={closeFeedbackHandler} />}      </div>
    );
  }
